...
TESTS_SPREADSHEET_URL = os.getenv(
    ...
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vSfC6zhjjg1MmwoBV2swtKt3mIseFLkzwHgsdJkt6E7wyGW0JdgoV_sbQhlk1CFp8BIt4cJ5-_lKKn9/pub?gid=185760317&single=true&output=csv',
)
